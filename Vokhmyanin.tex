...
\newcommand{\geoa}{    {\it Geomag. Aeron.}}
\newcommand{\lrsp}{    {\it Living Rev. Sol. Phys.}}
\newcommand{\sca}{    {\it Smithsonian Contributions to Astrophysics}}
\newcommand{\swe}{    {\it Space weather}}
\newcommand{\astnachr}{    {\it Astron. Nachr.}}
\newcommand{\npg}{    {\it Nonlin. Processes Geophys.}}
\newcommand{\raa}{    {\it Res. Astron. Astrophys.}}
\newcommand{\basi}{    {\it Bulletin of the Astron. Soc. of India}}
...
Asymmetry of various manifestations of solar magnetic fields in the hemispheres is known for longer than a century \citep{Spoerer1889,1901ApJ....13....1N,1904MNRAS..64..747M}. To analyse asymmetry of the low-latitude faculae and sunspots, \citet{1955MNRAS.115..398N} introduced ratio $N-S/N+S$ which became generally accepted to assess the dominance of an index in the northern $N$ or southern $S$ hemisphere. Let us define this ration as $NA$, amplitude asymmetry, or N--S asymmetry.

\citet{1957ZA.....43..149W} proposed a scenario that combined the amplitude asymmetry and the phase shift between the activity of the hemispheres by means of 80-year variation. Moreover, during the ascending phase of the secular cycle the northern activity dominates, on the descending phase, the southern one. The long-term asymmetry persisting for several cycles was confirmed by \citet{1962SCoA....5..187B} for both the sunspot activity and geomagnetic storms attributed to northern/southern sunspot groups. During Cycles 8 and 9, N--S asymmetry is northerly dominated, in Cycles 10\,--\,13, south dominates. The hemispheres are in balance in Cycle 14 ($NA\simeq 0$). From Cycle 15 to 20, north exceeds again. %\citet{2014NPGeo..21.1113Z} defined the reverses in the hemispheric predominance in 1905 (maximum of Cycle 14) and 1980 (maximum of Cycle 21).
\citet{1992ASPC...27..429V} predicted that the southern predominance in sunspots and flares over Cycles 21\,--\,24 will be replaced to the opposite one in Cycle 25.

\citet{1990A&A...229..540V} suggested a long-term periodic behavior in the asymmetry around eight cycles in which the activity in one hemisphere is larger during the ascending branch of the cycle and becomes larger in the opposite hemisphere during the descending branch.\citet{2002A&A...383..648L,2009SoPh..254..145L} hypothesised about an 12-cycle periodicity. N--S asymmetry also exhibits shorter periods \citep{2004A&A...418L..17K,2011NewA...16..357B,2017A&A...603A.109B,2015Ge&Ae..55..887N}.

The long-term variation is also confirmed in the phase shift (or phase asynchrony) of solar activity in the hemispheres \citep{2007A&A...475L..33D,2009A&A...503..197Z,2013ApJ...765..146M}, and in lengths of the butterfly wings \citep{1999A&A...341L..43P,2010AN....331..765Z,2016A&A...592A.160L}.

N--S asymmetry is also apparent in the differential rotation \citep{1997SoPh..170..389J}. From Cycle 14 to 20, the southern hemisphere was rotating faster than the the northern one \citep{1998A&A...332..748P,2013A&A...552A..84Z}. The hemispheric asymmetry is now exploiting as an input or output parameter in the dynamo models \citep{2009RAA.....9..115G,2013ApJ...779....4B,2013AN....334..960B,2014A&A...563A..18P,2015ApJ...799..220S}.

%Following the phase asymmetry of sunspots in the hemispheres, polar field reversals since 1975 also have all happened in the north first \citep{2013ApJ...763...23S}. Using a set of reversal dates compiled by \citet{1986BASI...14..163M}, \citet{2016ApJ...826..145M} confirmed this idea for the period 1870\,-–\,1981. Following the amplitude predominance of sunspots of the southern hemisphere %in comparison with those of the northern hemisphere
%since 1980 \citep{2014NPGeo..21.1113Z}, north-south asymmetry in the intensity distribution of background magnetic field over the solar surface from 2003 to 2011 .

The phase asymmetry of polar field reversals \citep{2013ApJ...763...23S,2016ApJ...826..145M}, hemispheric asynchrony of polar faculae \citep{2013AdSpR..51...87D}, and amplitude asymmetry of the intensity distribution of background magnetic field over the solar hemispheres \citep{2014SoPh..289.2867O} also exhibit the same behavior as observed in the asymmetry of sunspots \citep{2009ApJ...691..537L,2014NPGeo..21.1113Z}.

Due to the space climate and the magnetic field of the solar wind are driven by processes on the Sun, N--S discrepancy between the heliospheric hemispheres was also reported.
...
%the background fields over the solar surface are also found being more intense in the southern than in the northern hemisphere from 2003 to 2011


\citet{2009SoPh..254..145L} sign changed in 1880x? 1920x? and 1960x. Phase or amplitude?

%that the sign of the hemispheric phase discrepancy polar field reversals follows that of sunspots.





Карбонел \citet{2007A&A...476..951C}: statistical significance of the N--S asymmetry of solar activity provided by different authors, as well as studies of its behaviour, must be considered with care because they depend on size of averaging window, on the considered solar index, time step, etc.
...
persists for several cycles only on average


1832

percentage of spot activity occurring in the northern hemisphere in Cycles 8\,--\,19.
The same variation was found in percentage of geomagnetic storms attributed to northern spot groups.
...
Bell citation: the behaviour of the ratio reflects a phase difference on the ac The hemisphere that is the more spotted later in cycle tends to produce a majority of the great storms in that cycletivity of the two hemispheres, a phase difference that changes slowly with a period of the order of 80 years.
...
understanding the solar cycle evolution of the heliospheric magnetic field (HMF) and the solar wind

reorientation of HMF as the solar dipole rotates between the axial and equatorial orientations

solar cycle variation of the total heliospheric magnetic flux and its response to changes in solar magnetic fields

a recurrent north-south heliospheric asymmetry at solar minimum and the equatorial offset of the solar magnetic dipole.


%Ньютон и Милсом 1955 - с 11 по 13-й или 14-й цикл доминировало южное полушарие с 14-го или 15-го цикла - северное

\section{Old} \label{sec:old}

\begin{figure*}[ht!]
\plotone{NA_spots.eps}
\caption{(a) Yearly sunspot group counts in the hemispheres from observations by Schwabe, Sp\"{o}rer, and by the RGO. Blue fill color when the North counts is higher than the South counts, and red color when South is higher than North. Black curve is the secular mode of yearly sunspot groups of the entire solar disk by \citet{2015SpWea..13..529C,2016SoPh..291.2653S}. The cycle numbers refer to the Z\"{u}rich numbering. (b) Green thin curve denotes NA of yearly group counts, green thick curve its sliding 10-year average, and purple its long-term mode. Canvas is divided into two parts. Light blue marks dominance of the northern hemisphere, light red the southern hemisphere.\label{NA_spots}}
\end{figure*}

The unequal distribution of various aspects of solar activity between the north and south hemisphere of the Sun is well known for over a century. %использовать как первое предложение. Это цитата из Nair and Nayar 2008. только модифицировать немного.

%! выглялит рисуок так, что на фазе роста векового цикла доминирует активность северного полушария, а на фазе спада векового цикла доминирует южное полушарие.

Idea of Waldmeier on the asymmetry. We confirm that during the ascending phase of the secular cycle the northern activity dominates, on the descending phase, the southern one. Phase asymmetry exhibits similar behavior. During the ascending phase of the secular cycle the southern activity tends to precede, on the descending phase, the northern one.

Duration of the secular minima (and maxima) varies. For instance, the Dalton minimum is composed of three cycles (5, 6, and 7), the Gleissberg minimum of five cycles (from 12 to 16) \citep{2010LRSP....7....6P}. Periods of ascending and descending branches of a secular cycle are also not perfectly symmetrical.


Due to short-term variations and random fluctuations, and other reasons, the long-term periodicity of N--S asymmetry is hardly to define. Average persistence of one hemisphere can be not equal to that of the other hemisphere.
...
%{\tt\string \begin\{deluxetable\}}.
The main arguments the specifier takes
...
using multiple arguments.  For example,
%{\tt\string \begin\{figure\}[htb!]}
...
%{\tt\string tabular}
is surrounded by
%{\tt\string\begin\{table\}} ...
%{\tt\string\end\{table\}}
is it a true float and the rules and suggestions
above apply.
...
the article by adding the
%{\tt\string\listofchanges}
just before the
%{\tt\string\end\{document\}}
call.  The page number for each change will be
...
with %{\tt\string\begin\{longrotatetable\}}
and end with
%{\tt\string\end\{longrotatetable\}}.
...
\bibitem[Badalyan \& Obridko(2011)]{2011NewA...16..357B} Badalyan, O.~G., \& Obridko, V.~N.\ 2011, \na, 16, 357
\bibitem[Badalyan \& Obridko(2017)]{2017A&A...603A.109B} Badalyan, O.~G., \& Obridko, V.~N.\ 2017, \aap, 603, A109
\bibitem[Bell(1962)]{1962SCoA....5..187B} Bell, K.\ 1962, \sca, 5, 187
\bibitem[Belucz \& Dikpati(2013)]{2013ApJ...779....4B} Belucz, B., \& Dikpati, M.\ 2013, \apj, 779, 4
\bibitem[Belucz et al.(2013)]{2013AN....334..960B} Belucz, B., Forg{\'a}cs-Dajka, E., Dikpati, M.\ 2013, \astnachr, 334, 960
\bibitem[Carbonell et al.(2007)]{2007A&A...476..951C} Carbonell, M., Terradas, J., Oliver, R., et al.\ 2007, \aap, 476, 951
\bibitem[Clette et al.(2015)]{2015SpWea..13..529C} Clette, F., Cliver, E.~W., Lef{\`e}vre, L., et al.\ 2015, \swe, 13, 529
\bibitem[Deng et al.(2013)]{2013AdSpR..51...87D} Deng, L.~H., Qu, Z.~Q., Liu, T., et al.\ 2013, \asr, 51, 87
\bibitem[Donner \& Thiel(2007)]{2007A&A...475L..33D} Donner, R., \& Thiel, M.\ 2007, \aap, 475, L33
\bibitem[Goel \& Choudhuri(2009)]{2009RAA.....9..115G} Goel, A., \& Choudhuri, A.~R.\ 2009, \raa, 9, 115
\bibitem[Javaraiah \& Gokhale(1997)]{1997SoPh..170..389J} Javaraiah, J., \& Gokhale, M.~H.\ 1997, \solphys, 170, 389
\bibitem[Knaack et al.(2004)]{2004A&A...418L..17K} Knaack, R., Stenflo, J.~O., Berdyugina, S.~V.\ 2004, \aap, 418, L17
\bibitem[Leussu et al.(2016)]{2016A&A...592A.160L} Leussu, R., Usoskin, I.~G., Arlt, R.,  et al.\ 2016, \aap, 592, A160
\bibitem[Li et al.(2009)]{2009ApJ...691..537L} Li, K.~J., Gao, P.~X., Zhan, L.~S.\ 2009, \apj, 691, 537
\bibitem[Li et al.(2009)]{2009SoPh..254..145L} Li, K.~J., Gao, P.~X., Zhan, L.~S.\ 2009, \solphys, 254, 145
\bibitem[Li et al.(2002)]{2002A&A...383..648L} Li, K.~J., Wang, J.~X., Xiong, S.~Y., et al.\ 2002, \aap, 383, 648
\bibitem[Makarov \& Sivaraman(1986)]{1986BASI...14..163M} Makarov, V.~I., \& Sivaraman, K.~R.\ 1986, \basi, 14, 163
\bibitem[Maunder(1904)]{1904MNRAS..64..747M} Maunder, E.~W.\ 1904, \mnras, 64, 747
